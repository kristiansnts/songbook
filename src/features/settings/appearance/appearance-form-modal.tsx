...
export function AppearanceFormModal({ open, onOpenChange }: Props) {
    ...
    >
      <DialogContent className='sm:max-w-lg'>
        <DialogHeader className='text-left'>
          <DialogTitle>Update Appearance</DialogTitle>
          <DialogDescription>
            Customize your dashboard appearance. Click save when you're done.
          </DialogDescription>
        </DialogHeader>
