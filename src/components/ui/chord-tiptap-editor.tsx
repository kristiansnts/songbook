...
export function ChordTiptapEditor({ 
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: 'prose prose-sm sm:prose-base max-w-none focus:outline-none min-h-[200px] p-3 sm:p-4 border-0 text-sm sm:text-base leading-relaxed whitespace-pre-wrap',
      },
    },
    onUpdate: ({ editor }) => {
