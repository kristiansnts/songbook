...
export function SongViewer({ song }: SongViewerProps) {
  ...
  return (
    <div className='mx-auto w-full max-w-3xl space-y-4 px-3 py-4'>
      ...
      {/* Chord Switcher */}
      <ChordSwitcher showChords={showChords} onToggle={setShowChords} />
      ...
      <div ref={lyricsRef}>
        {song.lyrics_and_chords && song.lyrics_and_chords.trim() !== '' ? (
          ...
          <div className='text-muted-foreground py-8 text-center'>
            <p className='text-sm'>
              No lyrics and chords available for this song.
            </p>
          </div>
        )}
      </div>
